...
class MemCacheTriggerTriggerDetail(viewsets.ViewSet):
    ...
    def prepare_data_for_memory_cache(self, action_name=None):
        ...
        try:
            ...
            # 返回字典{triggerid_columnA: [triggerid, expression]}.
            ...
            2. return dic {triggerid_columnA: [triggerid, expression]}.
            '''
            for key, value in trigger_dic.items():
                ...
                for per_expression in trigger_detail:
                    temp_trigger_exp_lst.append([trigger_id, per_expression['expression']])
            ...
            # 返回所有columnA对应的device，格式{deviceid: [triggerid, expression]}.
            ...
            2. return dic {deviceid: [triggerid, expression]}.
            '''
            ...
            # 返回结果
            {
                deviceid1: [[triggerid, expression], [triggerid, expression]],
                deviceid2: [[triggerid, expression], [triggerid, expression]],
                ...
            }
