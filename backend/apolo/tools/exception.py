...
def exception_handler(e):
    ...
    if 'KeyError' in repr(e):
        ...
        logger.info("ValidationError error when execute serializer.is_valid(), detail: %s" % traceback.format_exc(e))
        return api_return(data=eval(json.dumps(data)))
        ...
        logger.info("MultipleObjectsReturned error when execute db query, detail: %s" % traceback.format_exc(e))
        return api_return(data=eval(json.dumps(data)))
